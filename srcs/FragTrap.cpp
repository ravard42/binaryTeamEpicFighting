...
/*   Updated: 2018/03/30 11:19:00 by ravard           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				FragTrap::takeDamage (unsigned int  amount ) {
	...
	std::cout << this->_name << " perd " << amount << " hp!" << std::endl << "Son total de hp vaut maintenant : " << this->_hp << std::endl;
	if (this->_hp == 0)
...
void				FragTrap::beRepaired( unsigned int amount ) {
	...
	std::cout << this->_name << " se heal de " << amount << " hp!" << std::endl << "Son total de hp vaut maintenant : " << this->_hp << std::endl;
}

randAttack const	FragTrap::_bank[] = {&FragTrap::attack1, &FragTrap::attack2, &FragTrap::attack3, &FragTrap::attack4, &FragTrap::attack5};

void				FragTrap::attack1( FragTrap & target ) {
	std::cout << "FR4G-TP " << this->_name  << " lance coup d'pompe dans l'oignon sur " << target.getName() << std::endl;
	target.takeDamage(20);
}

void				FragTrap::attack2( FragTrap & target ) {
	std::cout << "FR4G-TP " << this->_name  << " lance superNova sur " << target.getName() << std::endl;
	target.takeDamage(30);
}

void				FragTrap::attack3( FragTrap & target ) {
	std::cout << "FR4G-TP " << this->_name  << " lance jet de bière (8.6) sur " << target.getName() << std::endl;
	target.takeDamage(25);
}

void				FragTrap::attack4( FragTrap & target ) {
	std::cout << "FR4G-TP " << this->_name  << " lance brasier sur " << target.getName() << std::endl;
	target.takeDamage(30);
}

void				FragTrap::attack5( FragTrap & target ) {
	std::cout << "FR4G-TP " << this->_name  << " lance bad trip sur " << target.getName() << std::endl;
